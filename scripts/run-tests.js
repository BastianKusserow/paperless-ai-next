...
const TESTS = {
  ...
  'rag-active-result-set-reuse': 'test-rag-active-result-set-reuse.js',
  'rag-active-result-set-topic-reset': 'test-rag-active-result-set-topic-reset.js',
  'rag-multi-rewrite-retrieval': 'test-rag-multi-rewrite-retrieval.js',
...
const AREAS = {
  ...
  rag: [
    ...
    'rag-active-result-set-reuse',
    'rag-active-result-set-topic-reset',
    'rag-multi-rewrite-retrieval',
